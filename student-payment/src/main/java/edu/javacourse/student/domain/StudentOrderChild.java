...
@AttributeOverrides({
    ...
    @AttributeOverride(name = "certificateNumber", column = @Column(name = "c_cetificate_number")),
    @AttributeOverride(name = "certificateDate", column = @Column(name = "c_cetificate_date"))
    })
    @Embedded
    private Child child;
